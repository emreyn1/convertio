...
export const metadata: Metadata = {
  ...
  description: `Unleash your creativity with convertio – the ultimate online tool for
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={inter.className}>
        <ThemeProvider attribute="class" defaultTheme="light" enableSystem={false} enableColorScheme={false} themes={['light', 'dark']}>
          <Navbar />
          <Toaster />
